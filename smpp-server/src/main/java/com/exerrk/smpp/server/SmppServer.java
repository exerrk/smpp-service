...
public class SmppServer extends ServerResponseDeliveryAdapter implements Runnable, ServerMessageReceiverListener {
    ...
    public SmppServer(int port, String systemId, String password) {
        this.port = port;
    ...
    private static class WaitBindTask implements Runnable {
        ...
        public void run() {
            try {
                ...
                try {
                    if (BindType.BIND_TX.equals(bindRequest.getBindType()) || BindType.BIND_TRX.equals(bindRequest.getBindType())) {
